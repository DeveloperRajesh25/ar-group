    ...
    extend: {
      ...
      keyframes: {
        ...
        'drift-1': {
          ...
          '33%': { transform: 'translate3d(18%, -12%, 0) scale(1.2)' },
          '66%': { transform: 'translate3d(-12%, 16%, 0) scale(0.92)' },
        },
        'drift-2': {
          '0%, 100%': { transform: 'translate3d(0%, 0%, 0) scale(1.05)' },
          '33%': { transform: 'translate3d(-18%, 14%, 0) scale(0.9)' },
          '66%': { transform: 'translate3d(14%, -16%, 0) scale(1.18)' },
        },
        'drift-3': {
          '0%, 100%': { transform: 'translate3d(-6%, 4%, 0) scale(1.08)' },
          '50%': { transform: 'translate3d(8%, -8%, 0) scale(0.95)' },
        },
        'hue-shift': {
